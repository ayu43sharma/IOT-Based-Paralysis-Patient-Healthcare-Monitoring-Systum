...
<h3> Solution For Paralytic Patient Communication  </h3>
</td>
</tr>
</table>
</div>
...
{
if($_REQUEST['user'] == "health" && $_REQUEST['pwd'] == "health123")
{
$_SESSION['user'] = array("username" => "health", "password" => "health123");
